...
public:
	...
	public:
		...
		void SetValueChar(char vaule)
		{
			_valueChar = vaule;
			_type = TYPE_CHAR;
		}
		void SetValueUChar(unsigned char vaule)
		{
			_valueUChar = vaule;
			_type = TYPE_UCHAR;
		}
		void SetValueShort(short vaule)
		{
			_valueShort = vaule;
			_type = TYPE_SHORT;
		}
		void SetValueUShort(unsigned short vaule)
		{
			_valueUShort = vaule;
			_type = TYPE_USHORT;
		}
		void SetValueInt(int vaule)
		{
			_valueInt = vaule;
			_type = TYPE_INT;
		}
		void SetValueUInt(unsigned int vaule)
		{
			_valueUInt = vaule;
			_type = TYPE_UINT;
		}
		void SetValueLongLong(long long vaule)
		{
			_valueLongLong = vaule;
			_type = TYPE_LONGLONG;
		}
		void SetValueULongLong(unsigned long long vaule)
		{
			_valueULongLong = vaule;
			_type = TYPE_ULONGLONG;
		}
		void SetValueFloat(float vaule)
		{
			_valueFloat = vaule;
			_type = TYPE_FLOAT;
		}
		void SetValueString(char *vaule)
		{
			_valueString = vaule;
			_type = TYPE_STRING;
		}
		void SetValueData(void *data, unsigned int size)
		{
			_valueData.data = data;
			_valueData.size = size;
			_type = TYPE_DATA;
		}
...
public:
	...
	clElement *GetElement(unsigned int pageIndex);
	clElement *GetElement(unsigned int pageIndex, const char *name);
